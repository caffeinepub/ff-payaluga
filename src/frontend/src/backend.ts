...
import type { AdminDepositRequest as _AdminDepositRequest, AdminUpdateTournamentRequest as _AdminUpdateTournamentRequest, Time as _Time, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deposit(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllTournamentJoinRequests(): Promise<Array<TournamentJoinRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTournamentJoinRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBalanceByPrincipalId(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getBalanceByPrincipalId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBalanceByUserId(arg0: UserId): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getBalanceByUserId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntryFee(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntryFee();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingDepositRequests(): Promise<Array<AdminDepositRequest>> {
        if (this.processError) {
            try {
    ...
    async getPendingTournaments(): Promise<Array<MatchInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingTournaments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasOpenTournaments(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasOpenTournaments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isTournamentEntryOpen(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isTournamentEntryOpen();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async joinTournament(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setEntryFee(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setEntryFee(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setMatch(arg0: bigint, arg1: MatchInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setMatch(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setMatchCount(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setMatchCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setMatchTime(arg0: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setMatchTime(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setTournamentEntryOpen(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTournamentEntryOpen(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMatch(arg0: bigint, arg1: MatchInfo): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateMatchTime(arg0: bigint, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMatchTime(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTournament(arg0: AdminUpdateTournamentRequest): Promise<TournamentInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTournament(to_candid_AdminUpdateTournamentRequest_n17(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTournamentMatches(arg0: Array<AdminTournamentMatchUpdate>): Promise<Array<MatchInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTournamentMatches(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AdminDepositRequest_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AdminDepositRequest): AdminDepositRequest {
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AdminDepositRequest>): Array<AdminDepositRequest> {
    return value.map((x)=>from_candid_AdminDepositRequest_n14(_uploadFile, _downloadFile, x));
}
function to_candid_AdminUpdateTournamentRequest_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AdminUpdateTournamentRequest): _AdminUpdateTournamentRequest {
...
function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        matchTime: value.matchTime ? candid_some(value.matchTime) : candid_none(),
        status: value.status ? candid_some(value.status) : candid_none(),
        matchCount: value.matchCount ? candid_some(value.matchCount) : candid_none(),
