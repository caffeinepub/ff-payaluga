...
import { Menu, X, Home, Wallet, Trophy, LogIn, LogOut, Flame, Shield, CreditCard } from 'lucide-react';
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {isAuthenticated && (
              <>
                ...
                <Link
                  to="/tournament-entry"
                  className="flex items-center space-x-2 text-ff-gold hover:text-ff-orange transition-colors font-medium"
                >
                  <CreditCard size={18} />
                  <span>Entry</span>
                </Link>
                {isAdmin && (
                  <Link
                    to="/admin"
                    className="flex items-center space-x-2 text-ff-cyan hover:text-ff-orange transition-colors font-medium"
                  >
                    <Shield size={18} />
                    <span>Admin</span>
                  </Link>
          ...
          <div className="md:hidden py-4 space-y-3 border-t border-border/50">
            ...
            {isAuthenticated && (
              <>
                ...
                <Link
                  to="/tournament-entry"
                  className="flex items-center space-x-2 text-ff-gold hover:text-ff-orange transition-colors py-2 font-medium"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <CreditCard size={18} />
                ...
                {isAdmin && (
                  <Link
                    to="/admin"
                    className="flex items-center space-x-2 text-ff-cyan hover:text-ff-orange transition-colors py-2 font-medium"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    <Shield size={18} />
                    <span>Admin</span>
